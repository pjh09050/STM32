...
{
	if (htim -> Instance == TIM2) HAL_GPIO_TogglePin(GPIO_LED, LED1 | LED2);
	else if (htim -> Instance == TIM3) HAL_GPIO_TogglePin(GPIO_LED, LED3 | LED4);
	else if (htim -> Instance == TIM4) HAL_GPIO_TogglePin(GPIO_LED, LED5 | LED6);
}
/* USER CODE END 4 */
